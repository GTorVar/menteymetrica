...
<div id="app-clinica" style="border: 1px solid #ddd; padding: 25px; border-radius: 10px; background: #fdfdfd; font-family: sans-serif; max-width: 700px; margin: auto;">
  ...
  <label style="width: 10%;">Nombre:</label>
  <input id="nombre" type="text" style="width: 30%;">
  <label style="width: 12%;">Evaluador:</label>
  <input id="evaluador" type="text" style="width: 30%;">
  <br>
  <label style="width: 10%;">Fecha:</label>
  <input id="fecha" type="date" format="dd/mm/aaaa" style="width: 30%;">
