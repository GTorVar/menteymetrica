...
<div id="app-clinica" style="border: 1px solid #ddd; padding: 25px; border-radius: 10px; background: #fdfdfd; font-family: sans-serif; max-width: 700px; margin: auto;">
  ...
  <label style="width: calc(10% + 10px);">Nombre:</label>
  <input id="nombre" type="text" style="width: 28%">
  <label style="width: calc(12% + 10px);">Evaluador:</label>
  <input id="evaluador" type="text" style="width: 28%">
  <br>
  <label style="width: calc(10% + 10px);">Fecha:</label>
  <input id="fecha" type="date" format="dd/mm/aaaa" style="width: 28%">
  <br>
