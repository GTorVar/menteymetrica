...
<div id="app-clinica" style="border: 1px solid #ddd; padding: 25px; border-radius: 10px; background: #fdfdfd; font-family: sans-serif; max-width: 700px; margin: auto;">
  ...
  <label style="width: 5em;">Nombre:</label>
  <input id="nombre" type="text" style="width: 50%">
  <br>
  <label style="width: 5em;">Evaluador:</label>
  <input id="evaluador" type="text" style="width: 50%">
  <br>
  <label style="width: 5em;">Fecha:</label>
  <input id="fecha" type="date" format="dd/mm/aaaa" style="width: 25%">
  <br>
  <p style="font-style: italic; color: #555; text-align: center;">Durante las 2 últimas semanas, ¿con qué frecuencia le han afectado alguno de los siguientes problemas?</p>
...
function generarInforme() {
  ...
  const mm = (fecha.getMonth() + 1).toString().padStart(2, '0'); // Enero es 0
  ...
  doc.text(`${nombre}`, 37, 35);
  
  doc.setFont("helvetica", "bold");
  doc.text(`Evaluador:`, 20, 40);
  doc.setFont("helvetica", "normal");
  doc.text(`${evaluador}`, 41, 40);
  
  doc.setFont("helvetica", "bold");
  doc.text(`Fecha:`, 160, 35);
  doc.setFont("helvetica", "normal");
  doc.text(`${dd}/${mm}/${yyyy}`, 173, 35);
